...
This project is based on the code from [Peppermint-Lab/peppermint](https://github.com/Peppermint-Lab/peppermint) for development/deployment and adheres to its original license terms:

- **License**: This project follows the [Peppermint license](https://github.com/Peppermint-Lab/peppermint/blob/main/license), which includes:
  - Core code subject to its [Commercial License](https://github.com/Peppermint-Lab/peppermint)
  - Portions available under **AGPLv3** (GNU Affero General Public License v3)

- **Source**: Original repository — [https://github.com/Peppermint-Lab/peppermint](https://github.com/Peppermint-Lab/peppermint)

- **Copyright**: Copyright (c) 2020-present peppermint, Inc.
